...
import ovh.roro.gamepasschallenge.thewalls.util.item.modifier.BookModifier;
import ovh.roro.gamepasschallenge.thewalls.util.item.modifier.ItemModifier;
import ovh.roro.gamepasschallenge.thewalls.util.item.modifier.SkullModifier;
...
public class ItemBuilder implements Cloneable
{
     ...
     * @throws CloneNotSupportedException NEVER. It nether throws it but IntelliJ is yelling at me if it's not there :(
     */
    @Override
